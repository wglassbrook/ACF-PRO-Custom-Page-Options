		...
		<?php if( $wrap != 'nowrap' ){ // Paneled content?>
			...
			<div class="p-content <?php echo $wrap;?> <?php echo $width;?> columns">
				...
				<div class="panel-body">
					<iframe src="<?php echo get_template_directory_uri(); ?>/inc/acf_options/g_cal.php?bgcolor=%23f2f2f2&amp;src=<?php the_sub_field('gcal_embed') ?>" style="border: 0" width="100%" height="600" frameborder="0" scrolling="no"></iframe>
				</div>
			</div>
